    ...
    <div class="row">
        <div class="navbar navbar-static-top navbar-inverse">
            ...
            <div class="col-md-8 col-md-offset-8 icon_i text-right">
                ...
                <i class="iconfont icon-rili" style="margin-left: 20px;"></i> 2019-05-10
...
<div class="slid_bar">
    ...
    <div class="slid_bar_content navbar-fixed-top">
        ...
        <ul id="collapse_ul" class="collapse collapse_UL">
            <li><a href="#"  data-iframesrc="${pageContext.request.contextPath}/admin/user_manager.html?pageNum=1&pageSize=5"><i class="iconfont icon-jianhao"></i>用户管理</a></li>
