        ...
        <div style="margin: 0 20px 0 20px">
            ...
            <div class="collapse navbar-collapse  bs-js-navbar-scrollspy" id="collapsebar">
                ...
                <ul class="nav navbar-nav navbar-right hidden-sm">
                    ...
                    <li><a href="${pageContext.request.contextPath}/login"><span class="glyphicon glyphicon-console"></span> 注册</a></li>
                    <li><a href="${pageContext.request.contextPath}/login"><span class="glyphicon glyphicon-user"></span> 登录</a></li>
                </ul>
